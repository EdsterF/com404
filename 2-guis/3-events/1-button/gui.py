...
class Gui(Tk):
    ...
    def __add_heading_label(self):
        ...
        self.heading_label.grid(row=1, column=0, pady=10)  #sticky="ew") #sticky="ew" extends the label horizontally (this resolved
        ...
        self.heading_label.configure (font="Arial 16", #configure allows to configure multiple attributes in one go
                                      ...
                                      fg="black")#fg=foreground
                                       #pady moves the message down on the y axis
        # EVENTS
    ...
    def __add_instruction_label(self):
        ...
        self.instruction_label.grid(row=2, column=0, sticky=W, pady=10)

        #STYLE
        self.instruction_label.configure (#pady=10,
                                          font="Arial 12",
    ...
    def __add_tickets_entry(self):
        ...
        self.tickets_entry.grid(row=3, column=0, pady=10)
    ...
    def __add_buy_button(self):
        ...
        self.buy_button.grid(row=4, column=0, pady=1)
