...
class Gui(Tk):
    ...
    def __init__(self):
        ...
        # load resources
        self.tick_image = PhotoImage(file="C:\\Users\\eduardo franco\\Documents\\Python\\VisualStudioGIT\\com404\\2-guis\\3-events\\4-images\\4-hiding-and-showing\\tick.gif")
        self.cross_image = PhotoImage(file="C:\\Users\\eduardo franco\\Documents\\Python\\VisualStudioGIT\\com404\\2-guis\\3-events\\4-images\\4-hiding-and-showing\\cross.gif")
        self.default_image = PhotoImage(file="C:\\Users\\eduardo franco\\Documents\\Python\\VisualStudioGIT\\com404\\2-guis\\3-events\\4-images\\4-hiding-and-showing\\default.gif")
    ...
    def nights_box_completed(self,event):
        self.nights_submit = self.nights_box_entry.get()
        if self.nights_submit != int(""):
    ...
    def check_button_pressed(self,event):
        self.num_nights = self.nights_box_entry.get()

        if self.name_submit != str("") and self.passport_submit != "" and self.nights_submit in range (1, 365):
            messagebox.showinfo("Registration Check", "Registration submitted.")
       
       
        else:
            #messagebox.showinfo("Registration Check is not a valid number."
