...
class Gui(Tk):
    ...
    def __init__(self):
        ...
        # load resources
        self.tick_image = PhotoImage(file="U:\\com404\\2-guis\\4-images\\4-hiding-and-showing\\tick.gif")
        self.cross_image = PhotoImage(file="U:\\com404\\2-guis\\4-images\\4-hiding-and-showing\\cross.gif")
        self.default_image = PhotoImage(file="U:\\com404\\2-guis\\4-images\\4-hiding-and-showing\\default.gif")
    ...
    def check_button_pressed(self,event):
        ...
        if self.nights_submit < 1 or self.nights_submit > 365:
